...
Route::group( [ 'prefix' => 'controller' ], function() {
    Route::get(     'list',                             'SDNController@list'     )->name( 'controller/list'  );
    Route::get(     'status',                           'SDNController@status'   )->name('controller/status' );
    Route::get(     'add',                              'SDNController@edit'     )->name( 'controller/add'   );
    Route::get(     'edit/{id}',                        'SDNController@edit'     )->name( 'controller/edit'  );
